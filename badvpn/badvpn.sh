...
fun_udp1 () {
    ...
    menu
	    ...
	    inst_udp () {
            ...
            wget https://raw.githubusercontent.com/Pablohenrykyy/HD2/main/badvpn/badvpn-udpgw -o /dev/null
			wget https://raw.githubusercontent.com/Pablohenrykyy/HD2/main/badvpn/antcrashvpn.sh -o /dev/null
